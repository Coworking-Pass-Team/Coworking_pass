...
بدلاً من معاملة كل مساحة عمل ككيان واحد، يتم تصنيف وتقسيم كل مساحة عمل شريكة إلى **قسمين رئيسيين** (فئتين موحدتين برمجياً وتشغيلياً)، لكل منهما نموذج حجز وآلية عمل موحدة:
