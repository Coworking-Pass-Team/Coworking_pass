...
* **الميزات:**
  ...
  * **العضوية الشاملة (Universal Pass):** شراء اشتراك شامل (يومي، شهري، سنوي) يتيح الدخول لشبكة الشركاء بالكامل مع التقيد بحجز مساحة واحدة في المرة الواحدة.
...
* **الميزات:**
  ...
  * **العضويات الشاملة للشركات (B2B Bulk Passes):** شراء وتوزيع حصص العضويات على الموظفين المسجلين.
...
* **[FR-BOOK-02]** دعم شراء باقات ساعات لقاعات الاجتماعات والمسارح (ساعات/يوم أو ساعات/شهر) واحتساب الاستهلاك بدقة، مع إمكانية إلغاء الحجز وإعادة الساعات غير المستهلكة لرصيد الباقة.
* **[FR-BOOK-03]** دعم العضوية الشاملة (Universal Pass):
  ...
  * شمولية رصيد ساعات شهري لقاعات الاجتماعات والمسارح (مثل 8 ساعات شهرياً للباقة الشهرية، و20 ساعة للسنوية، ورصيد مؤسسي لباقات الشركات) يُخصم استهلاكها تلقائياً عند مسح كود الـ QR.
